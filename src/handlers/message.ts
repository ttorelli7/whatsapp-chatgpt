...
async function handleIncomingMessage(message: Message) {
    ...
    if (message.hasMedia) {
        ...
        let errorMsg = "Desculpe, não consegui entender o que você disse 🙁 Poderia digitar a mensagem? 📝 Assim, poderei responder da melhor forma. Obrigado pela compreensão! 😊";
